...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://startholidaytransfer.com/ru/kontakty',
    languages: {
      'en': 'https://startholidaytransfer.com/en/contact',
      'de': 'https://startholidaytransfer.com/de/kontakt',
      'tr': 'https://startholidaytransfer.com/tr/iletisim'
    }
  }
} 