...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://startholidaytransfer.com/ru/rezervatsiya/step2',
    languages: {
      'en': 'https://startholidaytransfer.com/en/reservation/step2',
      'de': 'https://startholidaytransfer.com/de/reservierung/step2',
      'tr': 'https://startholidaytransfer.com/tr/rezervasyon/adim2'
    }
  }
} 