...
export const metadata: Metadata = {
  title: 'Трансфер из аэропорта Анталии | Start Holiday Transfer',
  description: 'Забронируйте частный трансфер из аэропорта Анталии в отели Анталии, Аланьи, Белека, Сиде, Кемера и других курортов. Комфортные автомобили, профессиональные водители, фиксированные цены.',
  keywords: [
    'Анталия',
    'трансфер',
    'Алания',
  ...
  alternates: {
    canonical: 'https://startholidaytransfer.com/ru/rezervatsiya/step3',
    languages: {
      'en': 'https://startholidaytransfer.com/en/reservation/step3',
      'de': 'https://startholidaytransfer.com/de/reservierung/step3',
      'tr': 'https://startholidaytransfer.com/tr/rezervasyon/adim3'
    }
  }
} 