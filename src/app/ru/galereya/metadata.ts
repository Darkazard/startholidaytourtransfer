...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://startholidaytransfer.com/ru/galereya',
    languages: {
      'en': 'https://startholidaytransfer.com/en/gallery',
      'de': 'https://startholidaytransfer.com/de/galerie',
      'tr': 'https://startholidaytransfer.com/tr/galeri'
    }
  }
} 